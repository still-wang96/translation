...
% Overleaf 从 GitHub 仓库根目录启动编译；将翻译目录加入 TeX 的输入搜索路径。
\makeatletter
\def\input@path{{translation/}}
\makeatother
...
% 导言区
\graphicspath{{translation/}{translation/Fig/}{translation/images/}{Fig/}{images/}}% 可选：设置搜索路径(注意大小写)
...
%-----------------------------------------------------------------------------
\input{PREFACE/COVER.TEX} %备注：这里文件夹的名字必须严格区分大小写
\input{PREFACE/PREFACE0.TEX} 
...
%-----------------------------------------正文开始---------------------------------
\input{BOOK/CHAP1.TEX}       %第一章
\input{BOOK/CHAP2.TEX}       %第二章
\input{BOOK/CHAP3.tex}       %第三章
\input{BOOK/CHAP4.tex}       %第四章
\input{BOOK/CHAP5.tex}       %第五章
\input{BOOK/CHAP6.tex}
\input{BOOK/CHAP7.tex}
\input{BOOK/CHAP8.tex}       %第八章
\input{BOOK/CHAP9.tex}       %第九章
\input{BOOK/CHAP10.TEX}
\input{BOOK/CHAP11.TEX}
\input{BOOK/CHAP12.TEX}
\cleardoublepage
\input{BOOK/REFERENCES.TEX}
\cleardoublepage
\input{BOOK/INDEX.TEX}       %索引


\iffalse
%\include{preface/intro}
%\include{preface/intro2}
\include{PREFACE/PREFACE0.TEX}                                      %译者序
