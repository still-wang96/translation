...
\usepackage[CJKbookmarks,colorlinks,bookmarksnumbered=true,pdfstartview=FitH,pagebackref=true]{hyperref}   % 文献引用可点击，并在文献表中生成可点击的引用页码
\renewcommand*{\backrefalt}[4]{%
  \ifcase #1\relax
  \or \unskip\nobreak\hfill\penalty50\hskip1em\hbox{}\nobreak\hfill
      \mbox{\footnotesize$\uparrow$~#2}%
  \else \unskip\nobreak\hfill\penalty50\hskip1em\hbox{}\nobreak\hfill
      \mbox{\footnotesize$\uparrow$~#2}%
  \fi}
